...
function GetSpeed(x : float){
	
		movement.maxForwardSpeed = x;
	
	}


private var tempFWDSpeed : float;
private var gameTime : float;

function Update () {
	
	tempFWDSpeed = movement.maxForwardSpeed;
	
	if(tempFWDSpeed  < 90){
	
		movement.maxForwardSpeed += 0.5f;
		if(tempFWDSpeed > 20){
		
			movement.gravity = 500;
			movement.maxFallSpeed = 500;
		}
	...
	if(gameTime > 51200){
		...
		movement.maxForwardSpeed = 600.0f;
	
	}else if(gameTime > 25600){
		
		movement.maxForwardSpeed = 560.0f;
	
	}else if(gameTime > 12800){
		
		movement.maxForwardSpeed = 520.0f;
	
	}else if(gameTime > 6400){
		
		movement.maxForwardSpeed = 460.0f;
	
	}else if(gameTime > 3200){
		
		movement.maxForwardSpeed = 420.0f;
	
	}else if(gameTime > 1600){
		
		movement.maxForwardSpeed = 380.0f;
		
		movement.gravity = 1000;
		movement.maxFallSpeed = 1000;
	
	}else if(gameTime > 800){
		movement.maxForwardSpeed = 300.0f;
	
		movement.gravity = 900;
		movement.maxFallSpeed = 900;
		
	
	}else if(gameTime > 400){
		movement.maxForwardSpeed = 240.0f;
	
		movement.gravity = 700;
		movement.maxFallSpeed = 700;
		
	
	}else if(gameTime > 200){
		movement.maxForwardSpeed = 200.0f;
	
		movement.gravity = 800;
		movement.maxFallSpeed = 800;
		
		
	
	}else if(gameTime > 100){
	
		movement.maxForwardSpeed = 180.0f;
		...
		movement.maxForwardSpeed = 140.0f;
		
		movement.gravity = 600;
		movement.maxFallSpeed = 600;
